...
public class Main {
    public static void main(String[]args) {
        String textWithFractions1=MyFileReader.fileRead("fractions1.txt");//выдаёт "файл не найден"
        ...
        System.out.println(Arrays.toString(fractions1));//выдаёт "Деление на ноль" и меняет дробь на 1/1
